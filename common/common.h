...
struct common_params {
    ...
    int32_t batch_size_xlong      =     0; // logical batch size for xlong profile, 0 = inherit global
    int32_t ubatch_size_xlong     =     0; // physical batch size for xlong profile, 0 = inherit global
