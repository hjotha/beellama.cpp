static constexpr bool use_typical_moe_ncols = false;
...
// ---------------------------------------------------------------------------------------------
    ...
    return ggml_cuda_mmq_config(GGML_TYPE_COUNT, 256, 2, 64, 64, GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0, 256, use_typical_moe_ncols, false, true);
}
