...
static std::vector<std::unique_ptr<test_case>> make_test_cases_eval() {
        ...
        for (int b : {1, 7}) {
            for (bool v : {false, true}) {
                for (bool vs0 : {false, true}) {
                    test_cases.emplace_back(new test_get_rows(type, 256, 5, 4, b, 1, v, GGML_TYPE_COUNT, vs0));
                }
            }
        }
    }
    for (int b : {1, 7}) {
        for (bool v : {false, true}) {
            for (bool vs0 : {false, true}) {
                test_cases.emplace_back(new test_get_rows(GGML_TYPE_I32, 256, 5, 4, b, 1, v, GGML_TYPE_COUNT, vs0));
            }
        }
    }
...
// Conv_2D test cases
 ...
 // A deep layer of a ConvNet, several images in the batch
                                                ...
                                                for (ggml_prec prec : {GGML_PREC_F32, GGML_PREC_DEFAULT}) {
                                                    ...
                                                    for (ggml_type type_KV : {GGML_TYPE_F32, GGML_TYPE_F16, GGML_TYPE_BF16, GGML_TYPE_Q8_0, GGML_TYPE_Q5_1, GGML_TYPE_Q5_0, GGML_TYPE_Q4_1, GGML_TYPE_Q4_0, GGML_TYPE_IQ4_NL}) {
                                                        ...
                                                        test_cases.emplace_back(new test_flash_attn_ext(
                                                                    hsk, hsv, nh, {nr2, nr3}, kv, nb, mask, sinks, max_bias, logit_softcap, prec, type_KV, type_KV, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, v_is_view_of_k));
                                                        // run fewer test cases permuted
                                                        if (mask == true && max_bias == 0.0f && logit_softcap == 0 && kv == 512) {
                                                            test_cases.emplace_back(new test_flash_attn_ext(
                                                                        hsk, hsv, nh, {nr2, nr3}, kv, nb, mask, sinks, max_bias, logit_softcap, prec, type_KV, type_KV, {0, 2, 1, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, v_is_view_of_k));
                                                        }
                                                    }
                                                }
                                            }
    ...
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {8, 1}, 113, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true));
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {8, 1}, 1024, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true));
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {8, 1}, 1024, 64, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true));

    // Sparse mask hint: supported decode/prefill layouts and dense fallbacks.
    test_cases.emplace_back(new test_flash_attn_ext(512, 512, 1, { 8, 1}, 4096, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));
    test_cases.emplace_back(new test_flash_attn_ext(512, 512, 1, { 8, 2}, 4096, 3, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 768));
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {16, 1}, 4096, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true, 512));
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {16, 2}, 4096, 2, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true, 768));
    test_cases.emplace_back(new test_flash_attn_ext(512, 512, 1, { 8, 1}, 4096, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));
    test_cases.emplace_back(new test_flash_attn_ext(256, 256, 1, { 8, 1}, 4096, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));
    test_cases.emplace_back(new test_flash_attn_ext(128, 128, 1, { 8, 1}, 4096, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));

    test_cases.emplace_back(new test_flash_attn_ext(128, 128, 1, { 8, 1}, 4096, 4, true, false, 8.0f, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));

    // sparse mask with large batch size
    test_cases.emplace_back(new test_flash_attn_ext(512, 512, 1, { 8, 1}, 4096, 64, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));
    test_cases.emplace_back(new test_flash_attn_ext(512, 512, 1, { 8, 1}, 4096, 64, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {16, 1}, 4096, 64, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true, 512));
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {16, 1}, 4096, 64, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true, 512));
    test_cases.emplace_back(new test_flash_attn_ext(256, 256, 1, { 8, 1}, 4096, 64, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));
    test_cases.emplace_back(new test_flash_attn_ext(128, 128, 1, { 8, 1}, 4096, 64, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));
    test_cases.emplace_back(new test_flash_attn_ext(128, 128, 1, { 8, 1}, 4096, 64, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));

    // sparse mask + quantized cache
    test_cases.emplace_back(new test_flash_attn_ext(128, 128, 1, { 8, 1}, 4096, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));
    test_cases.emplace_back(new test_flash_attn_ext(128, 128, 1, { 8, 1}, 4096, 64, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 512));

    // more V-is-sub-view-of-K cases: other head shapes, and full views with equal head sizes
    test_cases.emplace_back(new test_flash_attn_ext(320, 256, 1, {32, 1}, 512, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true));
    test_cases.emplace_back(new test_flash_attn_ext(192, 128, 4, {8, 1}, 512, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true));
    test_cases.emplace_back(new test_flash_attn_ext(128, 128, 8, {4, 1}, 512, 8, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true));
    test_cases.emplace_back(new test_flash_attn_ext(64, 64, 4, {1, 1}, 512, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true));
    ...
    test_cases.emplace_back(new test_flash_attn_ext(64, 64, 4, {1, 1}, 512, 75, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 2, 1, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, false));
    test_cases.emplace_back(new test_flash_attn_ext(64, 64, 4, {4, 1}, 512, 75, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 2, 1, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, false));
    test_cases.emplace_back(new test_flash_attn_ext(64, 64, 4, {1, 1}, 1024, 75, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 2, 1, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, false));
    test_cases.emplace_back(new test_flash_attn_ext(64, 64, 4, {1, 1}, 512, 75, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, false));
    ...
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {20, 1}, 512, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true));
...
static std::vector<std::unique_ptr<test_case>> make_test_cases_perf() {
 ...
 // High resolution output (large NPQ)
    ...
    test_cases.emplace_back(new test_flash_attn_ext(512, 512, 1, { 8, 1}, 49152, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 0));
    test_cases.emplace_back(new test_flash_attn_ext(512, 512, 1, { 8, 1}, 49152, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, false, 0));
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {16, 1}, 49152, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true, 0));
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {16, 1}, 49152, 1, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, true, 0));
    ...
    for (int kv : { 4096, 8192, 16384,32768, 65536, }) {
        for (int hs : { 64, 128, 256, 576, }) {
            ...
            for (int nr : { 1, 4, 8, }) {
                for (int nb : { 1, 4096, }) {
    test_cases.emplace_back(new test_flash_attn_ext(hs, hsv, 8, {nr, 1}, kv, nb, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_F16, GGML_TYPE_F16, {0, 1, 2, 3}, 0, false, GGML_TYPE_F16, GGML_TYPE_COUNT, false, false, false, false, false, 0, false, 0.0f, -1, 0, true, v_view));
                }
            }
        }
    }
