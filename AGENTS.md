...
- You are already running directly on GOKAYA (.57). Never use SSH, sshpass, or SCP to 192.168.1.57 or localhost - execute commands and file operations directly in the local shell.
