...
class llama_kv_cache_paged : public llama_memory_i {
  public:
    ...
    bool seq_rm_cell(llama_seq_id /*seq_id*/, uint32_t /*cell_idx*/) override { return false; }
    int cells_at_pos(llama_seq_id /*seq_id*/, llama_pos /*pos*/, uint32_t * /*cell_indices*/, int /*n_max*/) override { return 0; }
